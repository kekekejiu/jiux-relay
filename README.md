...
Go + SQLite 单文件应用。功能：访问密码门、微信/QQ 内置浏览器拦截、多线路入口 + 前端延迟检测、302 中转点击统计、Admin 后台热更新网址。
...
├── handlers.go        # 前台:密码门/UA拦截/入口API/302中转
...
**首次登录后务必：1) 改后台密码 2) 改前台访问密码 3) 改后台路径。**
